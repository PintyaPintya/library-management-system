...
public class RemoveMember extends javax.swing.JFrame {
    ...
    public RemoveMember() {
        initComponents();
        setDefaultCloseOperation(RemoveMember.DISPOSE_ON_CLOSE);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ENTER MEMBER ID OR MEMBER NAME TO DELETE");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(56, 56, 56)
                        .addComponent(t1, javax.swing.GroupLayout.PREFERRED_SIZE, 377, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(86, 86, 86)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String query = "delete from member where member_id='"+input+"' or name='"+input+"';";
        ...
        try{
            ...
            if(rows > 0){
                ...
                JOptionPane.showMessageDialog(this,"No such member present");
            }
            stm.close();
        }
        catch(Exception e){
